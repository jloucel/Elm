...
This is a simple project to illustrate the use of the Elm programming language. Check out the demo here.
...
You can (and should) review the examples and even integrate Elm features into your existing site by embedding into JavaScript! Check it out here.  You can also take advantage of an active community on Reddit and Slack to help you get started.
